...
import CopyOfIdUploader from './DoctorComponentViews/doctorCopyId'
import bsCustomFileInput from 'bs-custom-file-input';

import { AdminSignUpActionCreator } from '../actions/adminSignUpActionCreator';
...
<option>Female</option>
  ...
  onSubmit(formValues) {
    ...
    // AdminSignUpActionCreator
    this.props.AdminSignUpActionCreator(formValues,()=>{
  ...
  render() {
    ...
    return (
      <div className='container mt-5 mb-5'>
        <h3 className='text-center text-secondary mb-5'>Add New Administrator</h3>
        <Form
...
export default reduxForm({
  ...
  validate,
})(connect(null, { AdminSignUpActionCreator })(AdminSignUpForm));
